...
# TODO: get this from previous HW
    ...
    while True:
        ...
        done_max_len = steps>=max_path_length
        rollout_done = bool(done) or done_max_len # HINT: this is either 0 or 1
...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=False,render_mode=('rgb_array')):
    ...
    while timesteps_this_batch < min_timesteps_per_batch:
        ...
        # TODO
        cur_sampled_path = sample_trajectory(env,policy,max_path_length,render,render_mode,)
        paths.append(cur_sampled_path)
        timesteps_this_batch = timesteps_this_batch + get_pathlength(cur_sampled_path)
...
def sample_n_trajectories(env, policy, ntraj, max_path_length, render=False,render_mode=('rgb_array')):
    ...
    for n in range(ntraj):
        cur_sampled_path = sample_trajectory(env,policy,max_path_length,render,render_mode)
        sampled_paths.append(cur_sampled_path)
